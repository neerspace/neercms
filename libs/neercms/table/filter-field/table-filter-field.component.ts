...
import {
  ...
  postfixes,
  textOperators,
} from 'neercms/table/sieve';
import { ColumnInfo, DataTableError, FilterType } from 'neercms/table/types';
...
export class TableFilterFieldComponent implements OnInit {
  ...
  constructor(
    ...
    public readonly numberInputProcessor: NumberInputProcessorService,
  ) {}
